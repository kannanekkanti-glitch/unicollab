  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'luxury': '0 20px 40px -15px rgba(15, 23, 42, 0.1), 0 0 0 1px rgba(255, 255, 255, 0.5) inset',
        'luxury-dark': '0 20px 40px -15px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.1) inset',
      },
      keyframes: {
        float: {
