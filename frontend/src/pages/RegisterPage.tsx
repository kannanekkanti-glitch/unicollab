...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 flex items-center justify-center bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-xl p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-6">
        <div className="text-center space-y-1">
          <div className="w-12 h-12 rounded-2xl bg-brand-600 text-white font-bold text-2xl mx-auto flex items-center justify-center shadow-md shadow-brand-500/20 mb-3">
            U
          </div>
